...
- cannot deploy using helmfile apply
    ```
    Error: Failed to get release home-ui in namespace local: exit status 1: WARNING: Kubernetes configuration file is group-readable. This is insecure. Location: /workspaces/home-env/.home-cluster-kubeconfig
  WARNING: Kubernetes configuration file is world-readable. This is insecure. Location: /workspaces/home-env/.home-cluster-kubeconfig
    ```
